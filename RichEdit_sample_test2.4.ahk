...
; Image pasting and table pasting (simple, anyway) work.
...
Zoom.Add("150 %", "Zoom")
Zoom.Add("125 %", "Zoom")
Zoom.Add("100 %", "Zoom100")
Zoom.Check("100 %")
Zoom.Add("75 %", "Zoom")
Zoom.Add("50 %", "Zoom")
File := MenuCreate()
File.Add("&Open", "FileOpen")
File.Add("&Append", "FileAppend")
File.Add("&Insert", "FileInsert")
File.Add("&Close", "FileClose")
File.Add("&Save", "FileSave")
File.Add("Save &as", "FileSaveAs")
File.Add()
File.Add("Page &Margins", "PageSetup")
File.Add("&Print", "Print")
File.Add()
File.Add("&Exit", "GuiClose")
Edit := MenuCreate()
Edit.Add("&Undo`tCtrl+Z", "Undo")
Edit.Add("&Redo`tCtrl+Y", "Redo")
Edit.Add()
Edit.Add("C&ut`tCtrl+X", "Cut")
Edit.Add("C&ut`tCtrl+X", "Copy")
Edit.Add("&Paste`tCtrl+V", "Paste")
Edit.Add("C&lear`tDel", "Clear")
Edit.Add()
Edit.Add("Select &all `tCtrl+A", "SelALL")
Edit.Add("&Deselect all", "Deselect")
Search := MenuCreate()
Search.Add("&Find", "Find")
Search.Add("&Replace", "Replace")

Alignment := MenuCreate()
Alignment.Add("Align &left`tCtrl+L", "AlignLeft")
Alignment.Add("Align &center`tCtrl+E", "AlignCenter")
Alignment.Add("Align &right`tCtrl+R", "AlignRight")
Alignment.Add("Align &justified", "AlignRight")

Indentation := MenuCreate()
Indentation.Add("&Set", "Indentation")
Indentation.Add("&Reset", "ResetIndentation")
LineSpacing := MenuCreate()
LineSpacing.Add("1 line`tCtrl+1", "Spacing10")
LineSpacing.Add("1.5 lines`tCtrl+5", "Spacing15")
LineSpacing.Add("2 lines`tCtrl+2", "Spacing20")

Numbering := MenuCreate()
Numbering.Add("&Set", "Numbering")
Numbering.Add("&Reset", "ResetNumbering")

Tabstops := MenuCreate()
Tabstops.Add("&Set Tabstops", "SetTabstops")
Tabstops.Add("&Reset to Default", "ResetTabStops")
Tabstops.Add()
Tabstops.Add("Set &Default Tabs", "SetDefTabs")

ParaSpacing := MenuCreate()
ParaSpacing.Add("&Set", "ParaSpacing")
ParaSpacing.Add("&Reset", "ResetParaSpacing")
Paragraph := MenuCreate()
Paragraph.Add("&Alignment", ":Alignment")
Paragraph.Add("&Indentation", ":Indentation")
Paragraph.Add("&Numbering", ":Numbering")
Paragraph.Add("&Linespacing", ":LineSpacing")
Paragraph.Add("&Space before/after", ":ParaSpacing")
Paragraph.Add("&Tabstopst", ":Tabstops")

Character := MenuCreate()
TextColor := MenuCreate()
Character.Add("&Font", "ChooseFont")
...
; Main Gui -------------------------------------------------------------------------------------------------------------
Gui := GuiCreate()
Gui.Opt("+ReSize +MinSize +hwndGuiID")
Gui, Menu, GuiMenu
Gui.MarginX := MarginX, Gui.MarginY := MarginY
; Style buttons
Gui.SetFont("Bold", "Arial")
Gui, Add, Button, xm y3 w20 h20 vBTSTB gSetFontStyle, &B
Gui.SetFont("Norm Italic")
...
SB.SetText(Stats.Line . " : " . Stats.LinePos . " (" . Stats.LineCount . ")  [" . Stats.CharCount . "]", 2)
Return
; ======================================================================================================================
; Gui related
; ======================================================================================================================
...
Class := WinGetClass("ahk_id" HControl)
...
If (Open_File) {
   If RE2.IsModified() {
      Gui.Opt("+OwnDialogs")
      r := MsgBox("Close File", "Content has been modified!`nDo you want to save changes?", 35)
      If r == "Cancel"
      {
         ControlFocus(RE2.HWND)
         Return
...
MakeMenu:
RTE_Menu := MenuCreate()    ; Simple context menu
RTE_Menu.Add("&Copy", "Copy2")
RTE_Menu.Add("&Paste", "Paste2")
RTE_Menu.Add("Cu&t", "Cut2")
RTE_Menu.Add("Select &All", "All2")
RTE_Menu.Add("&Undo", "Undo2")
RTE_Menu.Add("&Redo", "Redo2")
RTE_Menu.Add()
RTE_Menu.Add("Color", "e6FFe6")
RTE_Menu.Add("&Edit", ":Edit")
RTE_Menu.Add("&File", ":File")
RTE_Menu.Add("&Search", ":Search")
RTE_Menu.Add("&Format", ":Format")
RTE_Menu.Add("&View", ":View")
RTE_Menu.Show()
RTE_Menu.Add("Color", "FFFFFF")
return
